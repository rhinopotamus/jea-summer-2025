...
},
{
  ...
  "number": "1.2.2",
  "title": "",
  "body": "  At a local private college, the comprehensive fee is currently $64,000. The fee is projected to increase each year for the next several years.     Name the variables in this story:    letter name  =  everyday words  (units)  ~  dep or indep     =   ( )  ~      =   ( )  ~       Here is an empty table. Remember that the first column holds the letter names for the two variables, and by convention, the independent variable comes first. Fill in your two letter names.                      Here is a bunch of information about the filling tank; your job is to organize it into a table like the one above.  In 2 years, the fee is projected to be $71,600. In 4 years, the fee will be $80,200. The fee will reach $89,700 in 6 years, and $100,500 in 8 years. In 10 years, the fee will rise to $112,500.  (Isn't it much nicer to organize this information in a table than it is to have it all in written words?)      "
},
{
  "id": "subsec-graphs-2",
  "level": "2",
